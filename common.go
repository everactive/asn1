...
type fieldParameters struct {
	...
	littleEndian bool   // true iff this field is little-endian encoded
	class        *int   // if non nil, expected class for tag
	// Invariants:
